		...
		<div class="row">
			<div class="col-12">
              ...
              <b>Data Penitipan Uang {{$siswa->nama}}</b> 
                  ...
                  <!-- <td>
                    {{ $penitipan_uang->skorAmbil}}
                  </td> -->
                  <!-- <td> 
                    <?php 
                    $nabung = "{$penitipan_uang->nabung}";
                    $ambil = "{$penitipan_uang->ambil}";
                    $sisa = $nabung-$ambil;
                    echo $sisa;
                    ?>
                  </td> -->
        ...
        <form action="{{url('siswa')}}/{{$siswa->id}}/addpenitipan_uang" method="POST" enctype="multipart/form-data" >
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              ...
              <input name="ambil" id="ambil" type="text" class="form-control @error('ambil') is-invalid @enderror" value="{{ old('ambil') }}" placeholder="Ambil Uang" required autocomplete="ambil" autofocus>
              @error('ambil')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
        ...
        <form action="{{url('siswa')}}/{{$siswa->id}}/addpenitipan_uang" method="POST" enctype="multipart/form-data" >
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              ...
              <input name="nabung" id="nabung" type="text" class="form-control @error('nabung') is-invalid @enderror" value="{{ old('nabung') }}" placeholder="Tambah Uang" required autocomplete="nabung" autofocus>
              @error('nabung')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
