      ...
      <div class="col-md-6">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#upload">
...
<!-- Modal upload -->
<div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="editnisn" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editnisn"> 
      ...
      <div class="modal-body">
        <form action="{{ url('daftar_online') }}/{{$siswa->id}}/{{('addregistrasi_online')}}" method="POST" enctype="multipart/form-data"  >
          {{ csrf_field() }}
          <div class="form-group row">    
            <div class="col-md-12">
              <label>
                Upload Bukti Pembayaran Registrasi disini
              </label>
              <input id="registrasi_online" type="file" class="form-control @error('registrasi_online') is-invalid @enderror" name="registrasi_online" required autocomplete="registrasi_online" autofocus>
              @error('registrasi_online')
