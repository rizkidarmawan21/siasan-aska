          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-12">
              <div class="small-box bg-info">
                ...
                <a href="{{url('/siswa')}}" class="small-box-footer"> Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- Santri Baru -->
            <div class="col-lg-3 col-12">
              <div class="small-box bg-info">
                ...
                <a href="{{url('/daftar/dataditerima')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              <div class="small-box bg-success">
                ...
                <a href="{{url('/data_jenjang_smp1')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- SMP 2 -->
            <div class="col-lg-3 col-6">
              <div class="small-box bg-success">
                ...
                <a href="{{url('/data_jenjang_smp2')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- MTs -->
            <div class="col-lg-2 col-4">
              <div class="small-box bg-success">
                ...
                <a href="{{url('/data_jenjang_mts')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- SMK -->
            <div class="col-lg-2 col-4">
              <div class="small-box bg-success">
                ...
                <a href="{{url('/data_jenjang_smk')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- MA -->
            <div class="col-lg-2 col-4">
              <div class="small-box bg-success">
                ...
                <a href="{{url('/data_jenjang_ma')}}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
          </div>
...
@if(auth()->user()->role == 'Dewan Ustadz')
    ...
    @section('content')
      ...
      <head>
        <title> Data Santri Baru - Pondok Pesantren Askhabul Kahfi</title>
      </head>
