...
//////////////////////////////////////////////////////////
    ...
    protected $fillable = 
            ...
            'nisn', 'kk', 'nik', 'nokip', 'foto',
            'kampus', 'gedung', 'kamar', 'jenjang', 'kelas', 'ruang',
            'status', 'jalurpendaftaran', 
            'bulanpendaftaran', 'tahunpendaftaran', 'waktu'
        	];
...
//////////////////////////////////////////////////////////
	...
	// relasi ke registrasi_online
	public function registrasi_online(){
		return $this->hasMany(Registrasi_online::class);
	}
