...
Route::get('/daftar/dataditerima', [DaftarController::class, 'dataditerima']);
...
Route::get('/daftar/{id}/deletedataditerima', [DaftarController::class, 'deletedataditerima']);
...
//////////////////////////////////////////////////////////////////////////
Route::group(['middleware' => ['auth','checkRole:Administrator,Dewan Ustadz,Admin Kampus']],function(){
//////////////////////////////////////////////////////////////////////////
...
// Route::get('/umar201', [UmarController::class, 'index201']);
// Route::post('/umar201/create201', [UmarController::class, 'create201']);
// Route::get('/umar201/{id}/edit201', [UmarController::class, 'edit201']);
// Route::get('/umar201/{id}/editfoto201', [UmarController::class, 'editfoto201']);
// Route::post('/umar201/{id}/update201', [UmarController::class, 'update201']);
// Route::post('/umar201/{id}/updatefoto201', [UmarController::class, 'updatefoto201']);
// Route::get('/umar201/{id}/delete201', [UmarController::class, 'delete201']);
// Route::get('/umar201/{id}/detail201', [UmarController::class, 'detail201']);
// /////
// Route::post('/umar201/{id}/addpelanggaranumar201', [UmarController::class, 'addpelanggaranumar201']);
// Route::get('/umar201/{id}/{idpelanggaranumar201}/deletepelanggaranumar201', [UmarController::class, 'deletepelanggaranumar201']);
// Route::get('/umar201/{id}/printpelanggaran201', [UmarController::class, 'printpelanggaran201']);
// Route::get('/umar201/{id}/exportpelanggaran201', [UmarController::class, 'exportpelanggaran201']);

// Route::post('/umar201/{id}/addprestasiumar201', [UmarController::class, 'addprestasiumar201']);
// Route::get('/umar201/{id}/{idprestasiumar201}/deleteprestasiumar201', [UmarController::class, 'deleteprestasiumar201']);
// Route::get('/umar201/{id}/printprestasi201', [UmarController::class, 'printprestasi201']);
// Route::get('/umar201/{id}/exportprestasi201', [UmarController::class, 'exportprestasi201']);
/////
///////////////////////////////////////////////////////////////////////////////////

// Route::get('/syafii101', [SyafiiController::class, 'index101']);
// Route::post('/syafii101/create101', [SyafiiController::class, 'create101']);
// Route::get('/syafii101/{id}/edit101', [SyafiiController::class, 'edit101']);
// Route::get('/syafii101/{id}/editfoto101', [SyafiiController::class, 'editfoto101']);
// Route::post('/syafii101/{id}/update101', [SyafiiController::class, 'update101']);
// Route::post('/syafii101/{id}/updatefoto101', [SyafiiController::class, 'updatefoto101']);
// Route::get('/syafii101/{id}/delete101', [SyafiiController::class, 'delete101']);
// Route::get('/syafii101/{id}/detail101', [SyafiiController::class, 'detail101']);
// Route::get('/syafii101/{id}/export101', [SyafiiController::class, 'export101']);

// Route::post('/syafii101/{id}/addpelanggaransyafii101', [SyafiiController::class, 'addpelanggaransyafii101']);
// Route::get('/syafii101/{id}/{idpelanggaransyafii101}/deletepelanggaransyafii101', [SyafiiController::class, 'deletepelanggaransyafii101']);
// Route::get('/syafii101/{id}/print101', [SyafiiController::class, 'print101']);
